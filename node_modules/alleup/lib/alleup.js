...
console.log("upload end");
			_this.makeVariants(new_file, function(err, file){
				console.log("_this.makeVariants end");
	...
	makeVariants: function(file, callback) {
		...
		for(prefix in _resize) {
			console.log('prefix _resize:' + _resize);
...
console.log('imOptions x');
console.log('file '+ file['path']);
console.log('_size[1] '+ _size[1]);
